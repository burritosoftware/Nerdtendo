...
bot = lightbulb.BotApp(token=os.getenv('TOKEN'), prefix='n!', banner=None, intents=hikari.Intents.ALL_UNPRIVILEGED, default_enabled_guilds=(755956418619637820,439591923070533652,))
